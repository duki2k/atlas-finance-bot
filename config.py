...
# Intervalo base de atualização das análises (se quiser usar loop)
INTERVALO_MINUTOS = 360

# Notícias ativas
NEWS_ATIVAS = True

# Limite de rompimento (%)
# Sugestão: cripto 1.0, ações 1.5, fiis 2.0 — aqui vai geral
LIMITE_ROMPIMENTO_PCT = 2.0

# Portfólio (por categoria) — você pode trocar depois
ATIVOS = {
    "🪙 Criptomoedas": [
